...
public class Customers {
    ...
    public Customers(int customer_id, int customer_type_id, String customer_name, Date customer_birthday, byte customer_gender, String customer_id_card, String customer_phone, String customer_email, String customer_address) {
